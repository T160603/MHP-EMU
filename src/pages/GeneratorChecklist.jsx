...
import GeneratorChecklistComponent from '../components/GeneratorChecklistComponent';
import GeneratorChecklistDetailView from '../components/generatorChecklistDetailView';

const API_URL = "https://script.google.com/macros/s/AKfycbwCzaEcA76cQbkTOA-M98iIhcVuniLGx3l1DR9olXjrJCT1SsaJ54LciTv3uXumKIE/exec";
...
function GeneratorChecklist() {
  ...
  if (view === 'edit') {
    return <GeneratorChecklistComponent initialData={selectedRecord} onSave={saveRecord} onCancel={() => setView('dashboard')} />;
  }

  if (view === 'view') {
    return <GeneratorChecklistDetailView data={selectedRecord} onEdit={() => setView('edit')} onClose={() => setView('dashboard')} />;
  }
...
export default GeneratorChecklist;