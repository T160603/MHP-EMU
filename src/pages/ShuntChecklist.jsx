...
import ShuntChecklistComponent from '../components/ShuntChecklistComponent'
import ShuntChecklistDetailView from '../components/ShuntChecklistDetailView'


const API_URL = "https://script.google.com/macros/s/AKfycbyGKXO4qBg2RFM1cu7FBXcwMIVdJp2JTerxdKf-LR-BORg86zz3EbNjkriCJkzH0ys/exec";

function ShuntChecklist() {
  ...
  if (view === 'edit') {
    return <ShuntChecklistComponent initialData={selectedRecord} onSave={saveRecord} onCancel={() => setView('dashboard')} />;
  }

  if (view === 'view') {
    return <ShuntChecklistDetailView data={selectedRecord} onEdit={() => setView('edit')} onClose={() => setView('dashboard')} />;
  }
