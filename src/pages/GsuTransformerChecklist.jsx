...
import GsuTransformerChecklistComponent from '../components/GsuTransformerChecklistComponent';
import GsuTransformerChecklistDetailView from '../components/GsuTransformerChecklistDetailView';


const API_URL = "https://script.google.com/macros/s/AKfycbzPKbT_L8OqnDkMp1C56XWARPBLpBY3NJU4cQcZDhfofFCSkrqvHT_Ks5omTP0UJfw7/exec";

function GsuTransformerChecklist() {
  ...
  if (view === 'edit') {
    return <GsuTransformerChecklistComponent initialData={selectedRecord} onSave={saveRecord} onCancel={() => setView('dashboard')} />;
  }

  if (view === 'view') {
    return <GsuTransformerChecklistDetailView data={selectedRecord} onEdit={() => setView('edit')} onClose={() => setView('dashboard')} />;
  }
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-[#22c55e] font-black text-x">{record.Phase || 'New'}</h3>
                  </div>
...
export default GsuTransformerChecklist;