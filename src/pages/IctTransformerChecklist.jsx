...
import IctTransformerChecklistComponent from '../components/IctTransformerChecklistComponent';
import IctTransformerChecklistDetailView from '../components/IctTransformerChecklistDetailView'
...
function IctTransformerChecklist() {
  ...
  if (view === 'edit') {
    return <IctTransformerChecklistComponent initialData={selectedRecord} onSave={saveRecord} onCancel={() => setView('dashboard')} />;
  }

  if (view === 'view') {
    return <IctTransformerChecklistDetailView data={selectedRecord} onEdit={() => setView('edit')} onClose={() => setView('dashboard')} />;
  }
            ...
            {records.map((record, index) => (
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-[#22c55e] font-black text-xl">{record.Phase || '#'}</h3>
                  </div>
...
export default IctTransformerChecklist;